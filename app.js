...
app.get('/1',function(req,res){
    ...
    res.send({
        "description":"BLACKHATLOOK",
        "external_url":"https://gateway.pinata.cloud/ipfs/QmVpwkgLe9E5VsUbkci9p4KnXDUPpWncAPF9d8nfPoEPAC",
        "image":"https://gateway.pinata.cloud/ipfs/QmVpwkgLe9E5VsUbkci9p4KnXDUPpWncAPF9d8nfPoEPAC",
        "name":"GirlHat #1",
        "attributes":
            [
                    {"trait_type":"Background","value":"White"},
                    {"trait_type":"TOP","value":"Black"},
                    {"trait_type":"PANTS","value":"Printed"},
                    {"trait_type":"Hair","value":"UP"},
